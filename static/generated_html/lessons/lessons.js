...
// include: C:\Users\f0710\AppData\Local\Temp\tmpeq9wh80d.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = './../static/generated_html/lessons/lessons.data';
      var REMOTE_PACKAGE_BASE = 'lessons.data';
...
Module['FS_createPath']("/data/shaders", "junk", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_./../static/generated_html/lessons/lessons.data');

      };
      Module['addRunDependency']('datafile_./../static/generated_html/lessons/lessons.data');
...
// end include: C:\Users\f0710\AppData\Local\Temp\tmpeq9wh80d.js
// include: C:\Users\f0710\AppData\Local\Temp\tmpx0gfwd8w.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\f0710\AppData\Local\Temp\tmpx0gfwd8w.js
// include: C:\Users\f0710\AppData\Local\Temp\tmpv70p03cs.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\f0710\AppData\Local\Temp\tmpv70p03cs.js
