...
// include: C:\Users\f0710\AppData\Local\Temp\tmpdxmm747z.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = './../static/generated_html/lesson2/lesson2.data';
      var REMOTE_PACKAGE_BASE = 'lesson2.data';
...
Module['FS_createPath']("/data/shaders", "junk", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_./../static/generated_html/lesson2/lesson2.data');

      };
      Module['addRunDependency']('datafile_./../static/generated_html/lesson2/lesson2.data');
...
// end include: C:\Users\f0710\AppData\Local\Temp\tmpdxmm747z.js
// include: C:\Users\f0710\AppData\Local\Temp\tmp6ej0exsu.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\f0710\AppData\Local\Temp\tmp6ej0exsu.js
// include: C:\Users\f0710\AppData\Local\Temp\tmpre0sof4t.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\f0710\AppData\Local\Temp\tmpre0sof4t.js
